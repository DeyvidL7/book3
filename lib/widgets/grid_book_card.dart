...
class GridBookCard extends StatefulWidget {
  ...
  @override
  State<GridBookCard> createState() => _GridBookCardState();
}
...
class _GridBookCardState extends State<GridBookCard>
                      ...
                      children: [
                        ...
                        if (_userBook != null) ...[
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: _userBook!.statusColor.withOpacity(0.15),
                              borderRadius: BorderRadius.circular(8),
                              border: Border.all(
                                color: _userBook!.statusColor.withOpacity(0.4),
                                width: 0.5,
                              ),
                            ),
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  _getStatusShortName(_userBook!.status),
                                  style: TextStyle(
                                    fontSize: 7,
  ...
  String _getStatusShortName(ReadingStatus status) {
    switch (status) {
      case ReadingStatus.wantToRead:
        return 'QUIERO';
      case ReadingStatus.reading:
